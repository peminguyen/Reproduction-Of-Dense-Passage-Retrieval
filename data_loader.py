...
class NQDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # clear up with Sewon that this is how the paper does it.
        # Ablation: sample hard negative randomly, sample positive passage randomly
        # clear up with Sewon: there are multiple answers in `answers` field?
        ...
        #print(len(self.df['hard_negative_ctxs'][index]))
