...
class ROBERTA_QA(nn.Module):
    def __init__(self, tokenizer=RobertaTokenizer.from_pretrained('roberta-base')):
        ...
        print("Init")
        # encoder for question
        self.bert_q = RobertaModel.from_pretrained('roberta-base')
        print("Q")
        # encoder for passage
        self.bert_p = RobertaModel.from_pretrained('roberta-base')
        print("P")
